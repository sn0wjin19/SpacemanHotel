...
public class Registry extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SpannableStringBuilder spannable = new SpannableStringBuilder("1.输入手机号 > 2.输入验证码 > 3.设置密码");
        TextView registry_info = (TextView)findViewById(R.id.registry_info);
        ...
        Button registry_button = (Button)findViewById(R.id.registry_button);
